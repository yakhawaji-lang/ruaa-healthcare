...
- **الاستشارات الطبية عن بُعد (Telemedicine)**: مكالمات فيديو أو صوت داخل الموقع (Jitsi) — حجز ذاتي من مواعيد الأطباء
...
- التشغيل: `npm run migrate` (يطبّق `019_telemedicine.sql`) ثم أضف أول طبيب من **لوحة التحكم → الاستشارات عن بُعد → الأطباء**.
