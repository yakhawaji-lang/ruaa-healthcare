...
const T = {
  ar: {
    title: 'حجز استشارة عن بُعد', step_mode: 'نوع الاستشارة', step_doctor: 'الطبيب', step_time: 'الموعد', step_details: 'التفاصيل',
    video: 'مكالمة فيديو', video_sub: 'صوت وصورة عبر الكاميرا', audio: 'مكالمة صوتية', audio_sub: 'صوت فقط بدون كاميرا',
    any_doctor: 'أي طبيب متاح', any_doctor_sub: 'تختار الإدارة الطبيب والموعد المناسب وتُبلغك',
    pick_day: 'اختر اليوم', pick_time: 'اختر الوقت', no_days: 'لا توجد مواعيد متاحة خلال الأسابيع القادمة لهذا الطبيب. اختر طبيبًا آخر أو اترك الجدولة للإدارة.',
    ...
    summary: 'ملخص الحجز', doctor: 'الطبيب', when: 'الموعد', mode: 'النوع', tbd: 'تحدده الإدارة', price: 'الرسوم', sar: 'ريال', free_note: 'تُحدَّد الرسوم عند التأكيد',
  ...
  en: {
    title: 'Book a remote consultation', step_mode: 'Type', step_doctor: 'Doctor', step_time: 'Time', step_details: 'Details',
    video: 'Video call', video_sub: 'Audio and camera', audio: 'Voice call', audio_sub: 'Audio only, no camera',
    any_doctor: 'Any available doctor', any_doctor_sub: 'The team picks the doctor and time and notifies you',
    pick_day: 'Choose a day', pick_time: 'Choose a time', no_days: 'No available slots in the coming weeks for this doctor. Pick another doctor or let the team schedule.',
    ...
    summary: 'Booking summary', doctor: 'Doctor', when: 'Appointment', mode: 'Type', tbd: 'Set by the team', price: 'Fee', sar: 'SAR', free_note: 'Fee confirmed on scheduling',
